...
-- Créer les buckets seulement s'ils n'existent pas déjà
DO $$
BEGIN
...
-- Créer les politiques RLS pour le bucket images (uniquement si elles n'existent pas)
DO $$
BEGIN
...
-- Créer les politiques RLS pour le bucket documents (uniquement si elles n'existent pas)
DO $$
BEGIN
